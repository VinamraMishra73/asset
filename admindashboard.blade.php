...
footer p {
    margin: 0;
    text-align: left; /* Align the text inside the paragraph to the left */
    display: inline-block; /* Ensure the paragraph occupies only the necessary width */
}
    .left-logo {
            position: absolute;
            top: 8px;
  ...
  <div class="row">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a class="far fa-clock" href="{{ route('mprreport') }}"> <b>Monthaly Progress Report</b></a></li>
